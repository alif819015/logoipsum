...
const Footer = () => {
  return (
    <div className="md:mt-20">
      <div className="px-4 md:px-32 bg-gradient-to-r from-[#0076CE] to-[#9400D3]">
        <footer className="footer pt-9 pb-8 text-[#FFFFFF]">
          <aside>
            <img
              className="w-[138px] h-[45px] filter invert"
              src={img}
              alt=""
            />
            <p>
          ...
          <nav>
            <header style={{ lineHeight: "16px" }} className="font-bold">
              COMPANY
            </header>
        ...
        <footer
          ...
          className="footer pb-10 pt-8 border-t"
        >
